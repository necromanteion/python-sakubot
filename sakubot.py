...
# register plugins
sakubot.on(nick='necromanteion', text=cmds.bellyblocker)(cmds.belly)
sakubot.on(nick=cmds.not_necro, text=cmds.bellyblocker)(cmds.belly2)
...
sakubot.register('PRIVMSG', cmds.sakuball, text=cc.firstword('.sakuball'))
